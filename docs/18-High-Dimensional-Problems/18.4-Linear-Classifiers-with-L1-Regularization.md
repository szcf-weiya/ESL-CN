...
Friedman et al. (2010)[^3] 提出了用于拟合 $L_1$ 惩罚的逻辑斯底和多项式回归模型的非常快速的算法．他们应用 [18.3.2 节](../18-High-Dimensional-Problems/18.3-Linear-Classifiers-with-Quadratic-Regularization/index.html)中 \eqref{18.10} 中的对称多项式逻辑斯底回归模型，并且最大化带惩罚的对数似然
