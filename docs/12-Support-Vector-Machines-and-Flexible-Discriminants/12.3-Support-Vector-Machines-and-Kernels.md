...
这里我们用 **再生核希尔伯特空间 (reproducing kernel Hilbert space)** 中的函数估计来描述 SVM，其中有许多的核性质．这里的内容在[ 5.8 节](../05-Basis-Expansions-and-Regularization/5.8-Regularization-and-Reproducing-Kernel-Hibert-Spaces/index.html)有详细讨论．这里给出支持向量分类器的另一个视角，并且帮助理清它如何工作．
