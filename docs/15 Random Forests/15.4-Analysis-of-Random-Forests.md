...
!!! note "weiya注： Ex. 15.5"
    ...
    &=\frac{E[Cov_{\Theta_i\mid Z}(T(x;\Theta_1(Z)), T(x;\Theta_2(Z)))]+Cov[E_{\Theta_1\mid Z}T(x;\Theta_1(Z)), E_{\Theta_2\mid Z}T(x;\Theta_2(Z))]}{\sqrt{E[Var_{\Theta_1\mid Z}T(x;\Theta_1(Z))]+Var[E_{\Theta_1\mid Z}T(x;\Theta_1(Z))]}\sqrt{E[Var_{\Theta_2\mid Z}T(x;\Theta_2(Z))]+Var[E_{\Theta_2\mid Z}T(x;\Theta_2(Z))]}}
    \end{align}
    $$
    因为$T(x;\Theta_i(Z))$的自助采样和特征采样分别是独立同分布的，则$Cov_{\Theta_i\mid Z}[T(x;\Theta_1(Z)),T(x;\Theta_2(Z))]=0$且
    $$
    \begin{align}
    E_{\Theta_1\mid Z}T(x;\Theta_1(Z)&=E_{\Theta_2\mid Z}T(x;\Theta_2(Z))\\
    Var_{\Theta_1\mid Z}T(x;\Theta_1(Z))&=Var_{\Theta_2\mid Z}T(x;\Theta_2(Z))
    \end{align}
    $$
    则
    $$
